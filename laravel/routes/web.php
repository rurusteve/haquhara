...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::get('dashboard-data', [HomeController::class, 'getDashboardData'])->name('dashboards.data');
    Route::get('top-spenders', [HomeController::class, 'getTopSpenders'])->name('dashboards.top-spenders');
    Route::get('customer-by-provinces', [HomeController::class, 'getCustomersByProvinces'])->name('dashboards.customer-by-provinces');
    Route::get('channel-sales', [HomeController::class, 'getSalesByChannel'])->name('dashboards.sales-channel');
    ...
    // UTILITY
    Route::get('utility-transaction', [UtilityController::class, 'transaction'])->name('utility.transaction');
    Route::get('utility-product', [UtilityController::class, 'product'])->name('utility.product');
    Route::get('utility-customer', [UtilityController::class, 'customer'])->name('utility.customer');
    Route::get('utility-upload-data-form', [UtilityController::class, 'uploadDataForm'])->name('utility.upload-data-form');
    ...
    Route::get('utility-profile/{id}', [UtilityController::class, 'profile'])->name('utility.profile');
    ...
    Route::post('utility-import-sales', [UtilityController::class, 'importSales'])->name('utility.import-sales');
